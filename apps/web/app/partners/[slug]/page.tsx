...
import { PublicProvinceMap } from "../../../components/partners/PublicProvinceMap";
  ...
  return (
    <div className="lp pp-page">
      <section className="lp-section" style={{ borderBottom: `4px solid ${accent}` }}>
        <div className="lp-container pp-profile-header">
          <div>
            {profile.logoUrl ? (
              <Image src={profile.logoUrl} alt={`${profile.name} logo`} width={180} height={72} className="lp-trust-logo-img" />
            ) : null}
            ...
            {profile.websiteUrl ? (
              <a href={profile.websiteUrl} className="ds-btn ds-btn-secondary" target="_blank" rel="noopener noreferrer">
                Visit brand website
              </a>
            ) : null}
          </div>
