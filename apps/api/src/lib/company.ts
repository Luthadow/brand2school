/** Official enterprise details — keep in sync with apps/web/lib/company.ts */
...
export function formatCompanyAddressSingleLine(): string {
...
export function formatRegistrationLine(): string {

  return `Registration No.: ${COMPANY.registrationNumber}`;

}



export function formatTaxLine(): string {

  return `Tax No.: ${COMPANY.taxNumber}`;

}



/** PDF / print letterhead block */

export const LETTERHEAD = {

  companyName: COMPANY.legalName,

  registrationNo: formatRegistrationLine(),

  taxNo: formatTaxLine(),

  address: formatCompanyAddressSingleLine(),

  phone: `Phone / WhatsApp: ${COMPANY.phone}`,

  productLine: COMPANY.productLine
